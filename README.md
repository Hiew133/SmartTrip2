...
- **Trợ lý ngay trong chuyến đi** — một **cuộc trò chuyện** nổi ở góc màn hình, mở bằng nút
  ở đầu cột trái, đứng yên khi lịch trình bên cạnh cuộn. Nhắn như nhắn cho một người bạn
  rành đường, hỏi lại được, nói tiếp được ("thêm một quán nữa" hiểu "nữa" là gì). Hỏi thông tin thì nó trả lời; muốn đổi lịch trình
...
- **Một không gian, không phải năm tab** — cột trái giữ các mục và danh sách ngày, cột giữa
  ...
  cùng nói về ngày đó. Màn hẹp thì cột trái nằm xuống thành một dải ngang và trợ lý trải
  ngang thành một tấm dưới đáy màn hình.
